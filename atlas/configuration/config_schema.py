...
class AtlasConfig(Schema):
    ...
    ATTR_HABITATS = fields.Integer(missing=104)
    ATTR_AIRE = fields.Integer(missing=105)
    ATTR_POP = fields.Integer(missing=106)
    ATTR_MENACES = fields.Integer(missing=107)
